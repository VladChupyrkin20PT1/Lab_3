#include <modCipher.h>
modCipher::modCipher(const std::wstring & ws_key)
{
    std::wstring tmp(ws_key);
    columns = getValidKey(tmp);
}
void modCipher::set_tableform(const std::wstring& open_text)
{
...
std::wstring modCipher::encrypt(const std::wstring& open_text)
{
...
std::wstring modCipher::decrypt(const std::wstring& cipher_text)
{
...
inline int modCipher::getValidKey(std::wstring & ws_key)
{
    if (ws_key.empty())
...
inline std::wstring modCipher::getValidOpenText(const std::wstring & ws_open_text)
{
    std::wstring tmp;
...
inline std::wstring modCipher::getValidCipherText(const std::wstring & ws_cipher_text)
{
